...
class Splitter extends Device {
	...
	public void moveSignal(Signal signal){
		...
		if(fbWest != null && signal.sender.equals(fbWest.name)){
		...
		else if(fbNorth != null && signal.sender.equals(fbNorth.name)) {
			//create two new split signals and send
		...
		else if(fbEast != null && signal.sender.equals(fbEast.name)) {
			//create two new split signals and send
		...
		else if(fbSouth != null && signal.sender.equals(fbSouth.name)) {
			//create two new split signals and send
	...
	public void reflectSignal(Signal sig){
		if(sig.sender.equals(fbNorth.name)){
			sig.sender = name;
			fbNorth.moveSignal(sig);
		} else if(sig.sender.equals(fbEast.name)) {
			sig.sender = name;
			fbEast.moveSignal(sig);
		} else if(sig.sender.equals(fbSouth.name)){
			sig.sender = name;
